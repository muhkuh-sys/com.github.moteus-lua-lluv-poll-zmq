...
#
tSrcArchive = tarfile.open('lua-lluv-poll-zmq-0.1.0.tar.gz', 'r')
tSrcArchive.extractall('targets/depack')
tSrcArchive.close()
strDepackPath = 'targets/depack/lua-lluv-poll-zmq-0.1.0/'
